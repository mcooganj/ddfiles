...
"clear R cmd line before sending cmd from vim
let vimrplugin_ca_ck = 1

" open PDF after processing (the file generated by pdflatex)
let vimrplugin_openpdf = 1
let vimplugin_openpdf_quietly = 1
" need to look into the PDF settings Set env variable $R_PDFVIEWER ??

" open html following <ll>kh
let vimrplugin_openhtml = 1

" map <M-1> to <- when editing .r files
autocmd FileType r inoremap <buffer> ¡ <space><-<space>

" set function arg completion to <C-A>
